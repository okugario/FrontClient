        ...
        case 'SaveProfile':
          switch (ProfileMode.Mode) {
            case 'TransportProfile':
              if (Profile.Profile.Caption.length != 0) {
                ApiFetch(
                  `model/Vehicles${
                    'Id' in NewProfile.Profile
                  ...
                  (Response) => {
                    if (!('Id' in NewProfile.Profile)) {
                      Response.data.Owners.forEach((Owner) => {
                        Owner.VehicleId = Response.data.Id;
                      });
                      Response.data.Locations.forEach((Location) => {
                        Location.VehicleId = Response.data.Id;
                      });
                      Response.data.Equipments.forEach((Equipment) => {
                        Equipment.VehicleId = Response.data.Id;
                      });
